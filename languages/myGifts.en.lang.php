...
$strings = array(
  ...
  "LANG_SETUP_INSTALLTYPE_TEXT" => "",
	...
	"LANG_ADMIN_USERS_CREATE" => "New user",
  ...
  "LANG_ADMIN_SETUP_DISPLAYCLAIMERIFOWNER_YES" => "Claims are visible",
	...
	"LANG_ADMIN_SETUP_DONTDISPLAYCLAIMERNAME_YES" => "Do not display the name",
	...
	"LANG_ADMIN_SETUP_SEEPROPOSITIONS_YES" => "Gifts can be seen",
  "LANG_ADMIN_SETUP_ALERTS" => "Alerts",
  ...
  "LANG_ADMIN_SETUP_CURRENCY" => "Currency",
